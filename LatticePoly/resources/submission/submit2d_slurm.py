...
for n in range(Nstat):
        for batch in range(nb_batch):
                ...
                file.write("\n# Temporary directory\n")
                file.write("TEMPORARYDIR=/scratch/Cascade/${LOGNAME}/tmp\n")
                ...
                file.write("\n# Data directory\n")
                file.write("XNFSDIR=/Xnfs/lbmcdb/Jost_team/${LOGNAME}/data\n")
                ...
                file.write("cp ${SLURM_SUBMIT_DIR}/${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.out ${SCRDIR}\n")
                file.write("cp ${SLURM_SUBMIT_DIR}/${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.err ${SCRDIR}\n")
                ...
                # sbatch command
                command = f"sbatch {QARGS} -J {JOBNAME} {SCRIPTDIR}/slurm_sweep_tmp.sh"              
