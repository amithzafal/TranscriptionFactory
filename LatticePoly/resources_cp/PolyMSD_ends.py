...
class PolyMSD():
	...
	def __init__(self, outputDir, initFrame):
		...
		self.msdHomFile = os.path.join(self.reader.outputDir,"polyMSD_ends.res")
		...
		if sizeTot < vMem.available:
			...
			for idxTad in range(self.reader.nTad):
				if self.reader.polyType[idxTad] == 1:
					...
					if(((self.reader.SisterID[idxTad]<250 or self.reader.SisterID[idxTad]>750) and idxTad>1000) or ((idxTad<250 or idxTad>750)) and idxTad<1000):
